  ...
  data () {
    return {
      ...
      vbtn: { // v-btn Component
        ...
        filter: { icon: 'search', label: '', icon2: 'keyboard_arrow_up', props: { dark: true, light: false, icon: true, fab: false } },
        reload: { icon: 'replay', label: '', props: { dark: true, light: true, icon: true, fab: false } },
        create: { icon: 'add', label: '', props: { dark: true, light: false, icon: true, fab: false } },
        export: { icon: 'print', label: '', props: { dark: false, light: true, icon: true, fab: false } },
        close: { icon: 'close', label: '', props: { dark: true, light: false, icon: true, fab: false } },
        delete: { icon: 'delete', label: '', props: { dark: true, light: false, icon: true, fab: false } },
        update: { icon: 'save', label: '', props: { dark: true, light: false, icon: true, fab: false } },
        more: {
          icon: '',
          label: 'Load More',
          props: null,
